...
async function link_user(email, username, password) {
  //if the user created account without specifying username and would like to add.
  try {
...
export async function link_email(email, username, password) {
    //if the user created account without specifying email and would like to add.
